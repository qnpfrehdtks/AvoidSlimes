...
public class Boss8PatternFactory : PatternFactory
{

    public Boss8PatternFactory(BOSS boss) : base(boss)
    {
    ...
    protected override void createMovePattern()
    {
        ...
        SetMoverStat(MoveType.ToZero2, 0.0f, 1.0f, iTween.LoopType.none, iTween.EaseType.linear, "", "", "", 0.0f, 3.8f);
    }
