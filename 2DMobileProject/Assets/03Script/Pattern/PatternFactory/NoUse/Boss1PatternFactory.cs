...
public class Boss1PatternFactory : PatternFactory {



    public Boss1PatternFactory(BOSS boss) : base(boss)
    {
    ...
    protected override void createMovePattern()
    {
        ...
        SetMoverStat(MoveType.ROTATE1, 1.0f, 10.0f, iTween.LoopType.pingPong, iTween.EaseType.linear, "Hill");
    }
